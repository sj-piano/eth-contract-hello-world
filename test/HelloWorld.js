...
describe("HelloWorld contract", function () {
  ...
  async function deployHelloWorldFixture() {
    ...
    const contractHelloWorld = await ethers.deployContract("HelloWorld", constructorArgs);
  ...
  describe("Deployment", function () {
    ...
    it("Should set the initial message supplied to the constructor", async function () {
      const { contractHelloWorld, initialMessage } = await loadFixture(deployHelloWorldFixture);
